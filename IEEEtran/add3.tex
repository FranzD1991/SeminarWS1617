...
Insgesamt umfasst ADD sieben Schritte die innerhalb einer Design-Round auszuf\"uhren sind.\\

In der Abbildung \ref{fig_add3} ist schematisch dargestellt wie eine Design-Round aufgebaut ist und welche Schritte auszuf\"uhren sind.\\
...
Die Voraussetzung f\"ur die Nutzung von ADD 3.0 ist, dass bereits prim\"are funktionale Anforderungen und Szenarien erhoben sind. Dies bedeutet ADD findet nicht direkt in der Anforderungsgewinnung Anwendung, sondern erst danach. \\

\paragraph{Eingabe}
ADD wird von sogenannten Projekttreibern gesteuert. Projekttreiber sind die Eingaben, die vor einer Design-Round vorbereitet werden m\"ussen. Die vorzubereitenden Eingaben sind:\\
